...
(function () {
  ...
  /** @ngInject */
  function DashboardLineChartCtrl($scope, baConfig, layoutPaths, baUtil, $http) {
    ...
    var chartData = [
      { date: new Date(2017, 1, 10), value: 0, value0: 0 },
      { date: new Date(2017, 1, 11), value: 15000, value0: 19000},
      { date: new Date(2017, 1, 12), value: 30000, value0: 20000},
      { date: new Date(2017, 1, 13), value: 30000, value0: 20000}
      ];
    ...
    function zoomChart() {
      chart.zoomToDates(new Date(2017, 1, 10), new Date(2017, 1, 13));
    }
